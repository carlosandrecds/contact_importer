...
function handlemenutype(e) {
    ...
    var confMenuUsuario = localStorage.getItem("confMenuUsuario");

    if (!confMenuUsuario) {
        console.log("não tem configuração");
        localStorage.setItem("confMenuUsuario", "expanded");
        confMenuUsuario = "expanded";
    }

    var confMenuUsuarioContrario = "offcanvas";
    if (confMenuUsuario == "offcanvas"){
        confMenuUsuarioContrario = "expanded"
    }

    console.log("conf: "+confMenuUsuario+" confContra: "+confMenuUsuarioContrario)
...
$(document).ready(function() {
    ...
    $("#pcoded").pcodedmenu({
        ...
        defaultVerticalMenu: {
            desktop: confMenuUsuario,
            tablet: "offcanvas",
            phone: "offcanvas"
        },
        onToggleVerticalMenu: {
            desktop: confMenuUsuarioContrario,
            tablet: "expanded",
            phone: "expanded"
        }
    }),
