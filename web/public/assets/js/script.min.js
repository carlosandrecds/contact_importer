...
$(document).ready(function() {
    ...
    $(document).on('click', ".card-header-right .reload-card", function() {
        ...
        $('#'+loadid).parent().load(urlatual + ' #'+loadid, function() {
    ...
    $('#mobile-collapse').on('click', function() {
        ...
        var confMenuUsuarioLocal = localStorage.getItem("confMenuUsuario");
        if (confMenuUsuarioLocal == 'expanded'){
            localStorage.setItem("confMenuUsuario", "offcanvas");
        }else{
